<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="教材类型" prop="jiaocaileixing">
					<el-input v-model="ruleForm.jiaocaileixing" placeholder="教材类型" clearable  :readonly="ro.jiaocaileixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="教材类型" prop="jiaocaileixing">
					<el-input v-model="ruleForm.jiaocaileixing" placeholder="教材类型" readonly></el-input>
				</el-form-item>
			</template>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jiaocaileixing/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiaocaileixingCrossAddOrUpdateFlag = false;
						 this.parent.search();
